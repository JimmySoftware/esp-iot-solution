...
#define BOARD_IO_I2C0_SCL 27
#define BOARD_IO_I2C0_SDA 26

#define BOARD_IO_SPI2_SCK 14
#define BOARD_IO_SPI2_MOSI 13
#define BOARD_IO_SPI2_MISO 12
 ...
 */
/*
#define BOARD_TOUCH_SPI_CS_PIN 2
